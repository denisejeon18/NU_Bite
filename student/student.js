...
function showPaymentDetails() {
  ...
  if (method === "Cash on Pickup") {
    box.innerHTML = `
      <p>Please pay at the canteen counter when you pick up your order.</p>
    `;
  }
  ...
  if (method === "GCash QR Code") {
    box.innerHTML = `
      ...
      <img src="../images/instapay-qr.jpg" alt="GCash QR Code">
      <p>After payment, click Pay Now to confirm.</p>
    `;
  }
  ...
  if (method === "GCash Number Transfer") {
    box.innerHTML = `
      ...
      <p>After transfer, click Pay Now to confirm.</p>
    `;
  }
  ...
  if (method === "Instapay Transfer") {
    box.innerHTML = `
      ...
      <img src="../images/instapay-qr.jpg" alt="Instapay QR Code">
